...
public enum ErrorCode {
    ...
    ACCESS_FORBIDDEN(-12, "Access forbidden", HttpStatus.FORBIDDEN),
    IMAGE_NOT_FOUND(-13, "Image is not found", HttpStatus.NOT_FOUND),
    CURRENT_USER_DELETED(-14, "Current user is deleted", HttpStatus.GONE),
    STYLE_NOT_FOUND(-15, "Style is not found", HttpStatus.NOT_FOUND),
    STYLE_NOT_SUPPORTED(-16, "Style is not supported", HttpStatus.GONE),
    ALREADY_LIKED(-17, "Already liked", HttpStatus.CONFLICT),
    NOT_LIKED(-18, "Not liked", HttpStatus.CONFLICT),
